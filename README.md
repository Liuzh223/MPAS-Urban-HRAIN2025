...
| Single `$HOME/MPAS` workspace | Source builds, datasets, Release input, independent case, generated files, and output | All files installed, compiled, downloaded, or generated by the user |
